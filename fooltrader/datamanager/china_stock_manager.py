...
from fooltrader.api.technical import get_security_list, get_latest_kdata_timestamp, get_trading_dates, \
...
def crawl_index_quote():
    for _, security_item in get_security_list(security_type='index').iterrows():
        ...
        start_date, _ = get_latest_kdata_timestamp(security_item, source='163')
