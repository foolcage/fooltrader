...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--start_code', default='000777', help='the stock start code to be crawled')
    parser.add_argument('-e', '--end_code', default='000777', help='the stock end code to be crawled')
